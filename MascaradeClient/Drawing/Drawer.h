...
public:
	...
	////////////////////////////////////////////////////////////
	// interrupt the animation & return the time it was at
	////////////////////////////////////////////////////////////
	sf::Time interruptAnimation(DrawingAnimation* anim);
	...
	sf::Vector2f					getMousePosition() { return sf::Vector2f(sf::Mouse::getPosition(*m_Window)); }
